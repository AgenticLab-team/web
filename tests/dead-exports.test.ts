...
const TEST_ONLY: string[] = [
  ...
  "lib/forum/draft-rules.ts → canReadDraft",
  "lib/forum/follow-rules.ts → canSeeFollowList",
  "lib/forum/follow-rules.ts → unfollowIsDelete",
  "lib/forum/pin.ts → isPinExpired",
  "lib/forum/pin.ts → pinRemainingLabel",
  "lib/forum/reply-rules.ts → shouldMarkEdited",
  ...
  "lib/moderation/expiry.ts → activePunishment",
  ...
  "lib/notifications/prefs.ts → matchesFilter",
  ...
  "lib/queries/visibility.ts → filterToVisible",
