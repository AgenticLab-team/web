  ...
  return (
    <>
      ...
      <Link
         ...
         */
        className={`chrome t-footnote fixed left-4 z-30 inline-flex max-w-[min(60vw,14rem)] items-center gap-0.5 rounded-[var(--radius-pill)] py-2 pl-2 pr-3.5 font-medium text-[var(--accent)] shadow-lg transition-all duration-200 ${
